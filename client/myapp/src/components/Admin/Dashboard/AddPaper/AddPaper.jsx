			...
			<div className='flex flex-col space-y-6 p-6 md:p-10 w-full'>
				...
				<div>
					<button
						...
						className='flex space-x-2 items-center mb-6 bg-green-400 px-2 py-4 rounded-md text-white font-bold font-mono tracking-wider mx-auto mt-6 hover:scale-105 hover:shadow-md hover:bg-green-600 transition-all duration-200 '
					>
						<span>Add a question</span>
						<img src={add} alt='' className='w-6' />
					</button>

					{addQuestion && <AddQuestion socket={socket} data-aos='fade-up' />}
				</div>
			</div>
		</div>
	);
